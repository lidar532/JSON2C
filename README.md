...
using [onlinegdb.com](https://www.onlinegdb.com/#) as well as [Google Colab Examples](https://github.com/lidar532/JSON2C/blob/main/JSON2C_examples.ipynb) and running the gcc complier inside example cells.
